...
/* Test data for performance audit*/
INSERT INTO visits (animal_id, vet_id, date_of_visits) SELECT * FROM (SELECT id FROM animals) animal_id, (SELECT vet_id FROM vets) vet_id, generate_series('1980-01-01'::timestamp, '2021-01-01', '4 hours') visit_timestamp;
